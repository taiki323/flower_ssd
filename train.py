...
path_prefix = '/home/minelab/dataset/VOCdevkit/VOC2007/JPEGImages/' #原画像パス
batch_size = 4
for a in range(5):
    ...
    base_lr = 3e-5
    callbacks = [keras.callbacks.ModelCheckpoint('./checkpoints/PASCALVOC/PASCALVOC2007_weights_batch=' + str(batch_size) + '_lr=' + str(base_lr) + '.hdf5',
                                                 verbose=1,
                                                 save_best_only = True,
                                                 mode = "auto",
    ...
    drowpltloss(history, "gragh/PASCALVOC/PASCALVOC2007_batch=" + str(batch_size)  + "_lr=" + str(base_lr) + ".png",0,4.5)
    batch_size += 4
